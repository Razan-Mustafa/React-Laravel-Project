      ...
      <div class="container">
        <div class="row justify-content-xl-between">
          <div class="col-12 col-lg-4 col-xl-3dot1 mb-6 mb-md-10 mb-xl-0">
            ...
            <div class="d-md-flex d-lg-block">
              <div class="mb-5 mr-md-7 mr-lg-0">
                <h4 class="h6 mb-4 font-weight-bold font-size-17">
                  Need My Travel Help?
                </h4>
          ...
          <div class="col-12 col-md-6 col-lg-4 col-xl-1dot8 mb-6 mb-md-10 mb-xl-0">
            <h4 class="h6 font-weight-bold mb-2 mb-xl-4 font-size-17">
              Company
            </h4>
            ...
            <ul className="list-group list-group-flush list-group-borderless mb-0">
              <li>
                <Link
                  ...
                  class="text-decoration-on-hover list-group-item  list-group-item-action"
                  to={"/about"}
                >
                  About us
                </Link>
              ...
              <li>
                <a
                  class="list-group-item list-group-item-action text-decoration-on-hover"
